...
const typeDefs = gql `
    ...
    type Mutation {
        ...
        addProduct(sku: String!, name: String!, description: String!, usdPrice: String!, img: String!, imageAlt: String!, quantity: String!): Product
        editProduct(_id: ID!, sku: String!, name: String!, description: String!, usdPrice: String!, img: String!, imageAlt: String!, quantity: String!): Product
        updateProduct(_id: ID!, quantity: String!): Product
