...
function AddProduct() {
    ...
    const submitHandle = async (e) => {
        ...
        if (product.sku && product.name && product.description && product.usdPrice && product.img && product.imageAlt && product.quantity) {
    ...
    return (
        <>
            <form className="adminuItem">
                ...
                <input defaultValue={product.img} name="img" onChange={inputHandle} type="img"  placeholder='image file name'/>
